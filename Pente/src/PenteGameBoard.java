...
public class PenteGameBoard extends JPanel  implements MouseListener{
		...
		public void mouseClicked(MouseEvent e) {
			...
			int mouseX = e.getX();
			int mouseY = e.getY();
			//revalidate()System.out.println(e.getX() + "\t" +e.getY());
			playGame(e);
			repaint();
...
public void checkFor5Win(Square s){
	if(winY(s, true)>3|| winX(s, true)>3|| winD1(s, true)>3|| winD2(s, true)>3){
		repaint();
		String stateStr;
...
public int winY(Square s, Boolean winning){
	int row = s.getRow();
	int column = s.getCol();
	...
	if(row > 3){
		...
		while(contin == true && c2 < 4){
			if(theBoard[row-c2-1][column].getState() == theBoard[row-c2][column].getState()){
				i++;
				c2++;
			}else if(theBoard[row-c2-1][column].getState() == PenteMain.EMPTY
					&& theBoard[row-c2-2][column].getState() == theBoard[row][column].getState()
					&& winning == false){
				c2 = c2 +2;
				i++;
	...
	if(row < bWidthSquares - 4){
		...
		while(contin == true && c < 4){
			if(theBoard[row+c+1][column].getState() == theBoard[row+c][column].getState()){
				i++;
				c++;
			}else if(theBoard[row+c+1][column].getState() == PenteMain.EMPTY
					&& theBoard[row+c+2][column].getState() == theBoard[row][column].getState()
					&& winning == false){
				c = c + 2;
				i++;
...
public int winX(Square s, boolean winning){
	int row = s.getRow();
	int column = s.getCol();
	boolean didWin = false;
	boolean contin = true;
	...
	if(column > 3){
		...
		while(contin == true && c2 < 4){
			if(theBoard[row][column-c2-1].getState() == theBoard[row][column-c2].getState()){
				i++;
				c2++;
			}else if(theBoard[row][column-c2-1].getState() == PenteMain.EMPTY
					&& theBoard[row][column-c2-2].getState() == theBoard[row][column].getState()
					&& winning == false){
				c2 = c2 +2;
				i++;
	...
	if(column < bWidthSquares - 4){
		...
		while(contin == true && c < 4){
			if(theBoard[row][column+c+1].getState() == theBoard[row][column+c].getState()){
				i++;
				c++;
			}else if(theBoard[row][column+c+1].getState() == PenteMain.EMPTY
					&& theBoard[row][column+c+2].getState() == theBoard[row][column].getState()
					&& winning == false){
				c = c + 2;
				i++;
...
public int winD1(Square s, boolean winning){
	int row = s.getRow();
	int column = s.getCol();
	boolean didWin = false;
	boolean contin = true;
	...
	if(row > 3 && column < bWidthSquares - 4){
		...
		while(contin == true && c2 < 4){
			if(theBoard[row-c2-1][column+c2+1].getState() == theBoard[row-c2][column+c2].getState()){
				i++;
				c2++;
			}else if(theBoard[row-c2-1][column+c2+1].getState() == PenteMain.EMPTY
					&& theBoard[row-c2-2][column+c2+2].getState() == theBoard[row][column].getState()
					&& winning == false){
	...
	if(row < bWidthSquares - 4 && column > 3){
		...
		while(contin == true && c < 4){
			if(theBoard[row+c+1][column-c-1].getState() == theBoard[row+c][column-c].getState()){
				i++;
				c++;
			}else if(theBoard[row-c-2][column+c+2].getState() < bWidthSquares - 4
					&& theBoard[row+c-1][column-c+1].getState() == PenteMain.EMPTY
					&& theBoard[row-c-2][column+c+2].getState() == theBoard[row][column].getState()
					&& winning == false
					){
...
public int winD2(Square s, boolean winning){
	int row = s.getRow();
	int column = s.getCol();
	boolean didWin = false;
	boolean contin = true;
	...
	if(row < bWidthSquares - 4 && column < bWidthSquares - 4){
		...
		while(contin == true && c < 4){
			if(theBoard[row+c+1][column+c+1].getState() == theBoard[row+c][column+c].getState()){
				i++;
				c++;
			}else if(theBoard[row+c+1][column+c+1].getState() == PenteMain.EMPTY
					&& theBoard[row+c+2][column+c+2].getState() == theBoard[row][column].getState()
					&& winning == false){
